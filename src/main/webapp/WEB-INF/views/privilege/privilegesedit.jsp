...
<div id="breadcrumb">
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/app/privileges">Privileges</a>
			<span> >> </span></li>
		<li><a href="#" style="text-decoration: none;">Edit Privilege</a>
		</li>
	</ul>
</div>
<div class="content">
		...
		<div class="grid_12 full_block">
			<div class="widget_wrap">
				...
				<div class="widget_content">
					<h6>
						Edit Privilege :
						<c:out value='${privilege.description}' />
					</h6>
					<form:form modelAttribute="privilege"
						class="form_container left_label"
						action="${pageContext.request.contextPath}/app/edit-privilege"
						method="post">
							...
							<li>
								<fieldset>
									...
									<ul>
										...
										<li>
											<div class="form_grid_12">
												<label for="id" class="field_title">Resource</label>
												<div class="form_input">
													<form:textarea  type="text" id="name" name="name" path="name" rows="3" cols="100"></form:textarea>
												</div>
											</div>
										</li>
									</ul>
