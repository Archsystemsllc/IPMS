...
<div id="breadcrumb">
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/app/Models">Models</a>
			<span> >> </span></li>
		<li><a href="#" style="text-decoration: none;">New Model</a></li>
	</ul>
</div>
<div class="content">
		...
		<div class="grid_12 full_block">
			<div class="widget_wrap">
				...
				<form:form modelAttribute="program"
					class="form_container left_label" action="${pageContext.request.contextPath}/app/new-Model"
					method="post">
						...
						<ul>
							<li>
								...
								<li><label id="lfirstname" class="field_title"
									for="firstname" style="margin-left: 15px;">Model Type<span class="req">*</span>
									...
									<div class="form_input">
										<form:select id="organizationGroupId" name="organizationGroupId"
											...
											<c:forEach items="${referenceData.organizationGroupList}" var="group">
                                                        <c:if test="${group.id eq Model.organizationGroup.id}">
                                                        	<form:option selected="selected"  value="${group.id}">${group.name} </form:option>
                                                        </c:if>
                                                        <c:if test="${group.id ne Model.organizationGroup.id}">
