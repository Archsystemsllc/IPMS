...
<div id="breadcrumb">
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/app/meetings">Meetings</a>
			<span> >> </span></li>
		<li><a href="#" style="text-decoration: none;">Meeting
				Minutes</a></li>
	</ul>
</div>
<div class="content">
					...
					<div class="widget_wrap tabby">
						<div class="widget_top">
							<div id="widget_tab" style="float: left;">
								<ul>
									<li><a href="#tab1">Meeting Information</a></li>
									<li><a id="agenda" href="#tab2">Agenda</a></li>
									<li><a id="minutes" href="#tab3">Minutes</a></li>
									<li><a id="actionItems" href="#tab4">Action Items</a></li>
									<!--<li><a id="lessons" href="#tab5">Lessons Learned</a></li>  -->
								</ul>
							</div>
						</div>
											...
											<c:forEach var="agendaItem" items="${meeting.agendaItems}">
												<tr>
													...
													<td><span><a class="action-icons c-edit"
															...
															title="Create1">Create1</a></span></td>
												</tr>
											</c:forEach>
						...
						<div id="tab3">
							...
							<div class="widget_content">
								<span class="subheader-title">Meeting Minutes</span>
								<c:if test="${not empty success}">
									<div class="successblock">
										<spring:message code="${success}"></spring:message>
									</div>
						...
						<div id="tab4">
							...
							<div class="widget_content">
								<span class="subheader-title">Meeting's Action Items</span>
								<table class='display data_tbl'>
									<thead>
										<tr>
											<th>ID</th>
						...
						<div id="tab5">
							<%--<c:if test="${page=='actionitems'}">--%>
							<div class="widget_content">
								<span class="subheader-title">Meeting's Lessons Learned</span>
								<table class="display data_tbl">
									<thead>
										<tr>
											<th>Summary</th>
