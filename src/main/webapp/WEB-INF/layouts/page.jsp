...
$(function(){
    ...
    $("select#mettingagendatitle").change(function () {
    	alert("Testing");
        var val = $(this).val()
        if(val == "") return
        $.getJSON("/ipms-web/app/new-meetingagenda", {title: $(this).val()}, function(res,code) {
            $("#name").val(res.name)
            $("#age").val(res.age)
...
<div id="container">
    ...
    <c:if test="${view == 'groupdashboard'}">
        <div class="page_title">
            <span class="title_icon"><span class="computer_imac"></span></span>
            <h3>Horizontal Groups Dashboard</h3>
    ...
    <c:if test="${view == 'dashboard-bsg'}">
        <div class="page_title">
            <span class="title_icon"><span class="computer_imac"></span></span>
            <h3>Vertical Groups Dashboard of BSG</h3>
            <div class="top_search">
                <form action="#" method="post">
                    <ul id="search_box">
                        <li>
    ...
    <c:if test="${view == 'seamless'}">
        <div class="page_title">
            <span class="title_icon"><span class="computer_imac"></span></span>
            <h3>SCMG Models Dashboard</h3>
            <div class="top_search">
                <form action="#" method="post">
                    <ul id="search_box">
                        <li>
    ...
    <c:if test="${view == 'projectdashboard'}">
        <div class="page_title">
            <span class="title_icon"><span class="computer_imac"></span></span>
